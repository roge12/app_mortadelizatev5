...
var Webcam = {
	...
	attach: function(elem) {
		...
		if (this.userMedia) {
			...
			div.innerHTML = '<div class="esquinas-camara"><div class="encuadre"></div></div>';
	...
	snap: function(user_callback, user_canvas) {
		...
		src64_imagen = canvas.toDataURL();
		console.log("ESto es uri:"+src64_imagen);
	...
	upload: function(image_data_uri, target_url, callback) {
		...
		console.log("ESto es uri:"+image_data_uri);
		...
		console.log("aqui: "+raw_image_data);
